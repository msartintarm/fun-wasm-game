...
export const CONFIG_FIELDS: ConfigFieldMeta[] = [
  ...
  { key: "boostMultiplier", label: "Boost multiplier", min: 1, max: 5, step: 0.1, description: "Speed multiplier per active boost source (proximity/food/edge), for player and AI alike — stacks when multiple are active at once" },
